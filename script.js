...
$(document).ready(function(){
   ...
   var url11 = url +url1 +near +url2+ type;;
        ...
        $.getJSON(url11, function(response){
             ...
             $("#Results").append("Phone Number"+"<br>" + response.response.venues[0].phone + "<br>"); 
             $("#Results").append("Address"+"<br>" + response.response.venues[0].location.address + "<br>"); 
